...
namespace RadioLock
{
    public class CardInfoService : ServiceBase<CardInfo2>
    {
        ...
        protected override object Run(CardInfo2 request)
        {
            ...
            RadioLockConnector.ConnectionString = String.Format("Data Source=.\\SQLHotelLock;Initial Catalog=RadioLock;Integrated Security=False;User Id=sa;Password=123;MultipleActiveResultSets=True", Settings.Default.LockFolder);
            WriteLog("ConnectionString:" + RadioLockConnector.ConnectionString);
