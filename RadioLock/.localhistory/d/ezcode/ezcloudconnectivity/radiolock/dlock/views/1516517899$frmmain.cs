...
namespace RadioLock
{
    public partial class frmMain : Form
    {
        ...
        private void SelectInstallationFolder()
        {
            ...
            ClockConnector.ConnectionString = String.Format("Data Source=" +  +;Initial Catalog=Green;Integrated Security=False;User Id=sa;Password=123456;MultipleActiveResultSets=True", txtLocation.Text);
