...
namespace RadioLock
{
    internal class LLockConnector
    {
        ...
        [DllImport("Dev_C_Sharp.dll", EntryPoint = "TP_Configuration")]
        public static extern int TP_Configuration(Int16 LockType);

        [DllImport("Dev_C_Sharp.dll", EntryPoint = "TP_MakeGuestCard")]
        ...
        [DllImport("Dev_C_Sharp.dll", EntryPoint = "TP_ReadGuestCard")]
        ...
        [DllImport("Dev_C_Sharp.dll", EntryPoint = "TP_ReadGuestCardEx")]
        ...
        [DllImport("Dev_C_Sharp.dll", EntryPoint = "TP_CancelCard")]
        public static extern int TP_CancelCard(StringBuilder card_snr);

        [DllImport("Dev_C_Sharp.dll", EntryPoint = "TP_GetCardSnr")]
