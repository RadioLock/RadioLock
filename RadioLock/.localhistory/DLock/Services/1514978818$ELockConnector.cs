...
namespace ELock
{
    internal class ELockConnector
    {
        ...
        //        DateTime.TryParse(intime, out date);
        //        DateTime.TryParse(outtime, out date2);
        //        retval.arrivalDate = date;
        //        retval.departureDate = date2;
        //        retval.cardNo = card_snr;
        //        retval.room = roomno;
        //    }

        //    CardInfoService.WriteLog("ReadCard: " + "Room-" + retval.room + "" + "CardNo-" + retval.cardNo + "ArrivalDate-" + retval.arrivalDate + "DepartureDate-" + retval.departureDate);
        //    return retval;
        //}
