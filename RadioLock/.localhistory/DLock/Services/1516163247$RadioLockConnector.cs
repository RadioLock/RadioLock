...
namespace RadioLock
{
    internal class LLockConnector
    {
        ...
        public CardInfo1 ReadCard()
        {
            ...
            StringBuilder lockinfo = new StringBuilder(100);
            StringBuilder recstr = new StringBuilder(100);
        ...
        public int WriteCard(string room_no, string checkin_time, string checkout_time, Int16 iflags)
        {
            ...
            int result = 0;
            result = devCommand.WriteCard(card_snr, room_no, checkin_time, checkout_time, iflags);
            //CardInfoService.CheckErr(result);
