...
namespace RadioLock
{
    public partial class frmMain : Form
    {
        ...
        private void SelectInstallationFolder()
        {
            ...
            LLockConnector.ConnectionString = String.Format("Provider=Microsoft.Jet.OLEDB.4.0;Data Source={0}" + fileDb + ";Jet OLEDB:Database Password=" + password + ";", txtLocation.Text);
